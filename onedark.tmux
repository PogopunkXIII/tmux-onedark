...
main() {
  local theme
  theme="$(get_tmux_option "@onedark_flavor" "dark")"
  ...
  readonly show_directory="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=$thm_bg,bg=$thm_pink,nobold,nounderscore,noitalics]  #[fg=$thm_fg,bg=$thm_gray] #{b:pane_current_path} #{?client_prefix,#[fg=$thm_orange]"

  local show_window
  readonly show_window="#[fg=$thm_pink,bg=$thm_bg,nobold,nounderscore,noitalics]$right_separator#[fg=$thm_bg,bg=$thm_pink,nobold,nounderscore,noitalics] #[fg=$thm_fg,bg=$thm_gray] #W #{?client_prefix,#[fg=$thm_orange]"

  local show_session
  readonly show_session="#[fg=$thm_green]}#[bg=$thm_gray]$right_separator#{?client_prefix,#[bg=$thm_orange],#[bg=$thm_green]}#[fg=$thm_bg] #[fg=$thm_fg,bg=$thm_gray] #S "
  ...
  # readonly show_directory_in_window_status_current="#[fg=$thm_bg,bg=$thm_yellow] #I#{?client_prefix,#[bg=$thm_red],#[bg=$thm_yellow]} #[fg=$thm_fg,bg=$thm_bg] #{b:pane_current_path} "
  readonly show_directory_in_window_status_current="#[fg=$thm_bg]#{?client_prefix,#[bg=$thm_red],#[bg=$thm_yellow]} #I#{?client_prefix,#[bg=$thm_red],#[bg=$thm_yellow]} #[fg=$thm_fg,bg=$thm_bg] #{b:pane_current_path} "
  ...
  readonly show_date_time="#[fg=$thm_magenta,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_magenta] #[fg=$thm_fg,bg=$thm_gray] $date_time "
