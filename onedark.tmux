...
main() {
  ...
  readonly show_directory_in_window_status_current="#[fg=$thm_bg,bg=$thm_yellow][fg=$thm_fg,bg=$thm_bg] #{b:pane_current_path} "
  ...
  readonly show_date_time="#[fg=$thm_magenta,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_blue] #[fg=$thm_fg,bg=$thm_gray] $date_time "
